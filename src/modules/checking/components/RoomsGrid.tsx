...
interface RoomsGridProps {
  rooms: Room[];
  onChangeStatus: (roomId: number, status: RoomStatus) => void;
}
...
export function RoomsGrid({ rooms, onChangeStatus }: RoomsGridProps) {
  return (
        ...
        >
          ...
          <div className="p-4 space-y-3">
            ...
            <div>
              ...
              <Select
                value={room.status}
                onValueChange={(v) => onChangeStatus(room.id, v as RoomStatus)}
              >
